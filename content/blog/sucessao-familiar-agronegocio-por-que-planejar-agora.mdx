...
faqs:
  - question: "Por que a maioria das fazendas familiares não sobreviveb à segunda geração?"
    answer: "Cerca de 70% das propriedades rurais falham na transição devido a falhas na comunicação familiar, falta de uma estrutura jurídica adequada (como holdings e acordos de sócios), conflitos emocionais não mediados e a falta de preparação administrativa dos sucessores."
  - question: "Quais são os três pilares de uma sucessão planejada no agronegócio?"
    answer: "A sucessão se sustenta em: 1) Governança Familiar (diálogo e combinados claros), 2) Estrutura Jurídica e Patrimonial (blindagem jurídica do patrimônio) e 3) Preparação do Sucessor (treinamento gradual em gestão)."
  - question: "Como iniciar a conversa sobre sucessão na fazenda sem gerar conflitos?"
    answer: "Escolha um momento tranquilo e neutro (fora do ambiente direto de trabalho), foque em ouvir as aspirações de cada membro antes de impor soluções e, se necessário, traga um consultor externo neutro para mediar."
---
