...
| :--- | :--- | :--- | :--- |
| **NOAA / CPC (EUA)** | 97% de persistir até o início de 2027 | 81% de "muito forte" | out–dez/2026 |
| **IRI / Universidade Columbia** | ~98% a 100% ao longo do ciclo | Metade dos modelos: muito forte (≥ +2,0 °C) | set–nov/2026 |
| **INMET / INPE (Brasil)** | Acima de 90% até, no mínimo, início de 2027 | "Muito forte" (TSM acima de 2,0 °C) | primavera–verão 2026/27 |
...
Aqui vale um freio de arrumação, porque circula muita bobagem. **O efeito médio do El Niño sobre a soja costuma ser neutro a levemente positivo em escala global** — a expectativa-base segue sendo de uma safra brasileira cheia. O que o fenômeno adiciona é **volatilidade**: notícia de clima extremo mexe com Chicago, e o risco de calendário sobre a safrinha de milho é real.
...
O detalhe que interessa: esse ITU é calculado a partir de **temperatura e ponto de orvalho** — as mesmas variáveis que uma estação na sede mede o tempo todo. O mesmo equipamento que ajuda a decidir a pulverização da soja ajuda a saber a hora de ligar a ventilação e a aspersão no confinamento.
...
E essa diferença não é detalhe. Temperatura, umidade e vento variam pouco dentro de uma mesma região. **A chuva, não.** Todo produtor conhece a cena: chove forte num talhão e, do outro lado da estrada, o vizinho fica olhando a nuvem passar. A estação meteorológica pública mais próxima pode estar a dezenas de quilômetros — e, num ano de El Niño, decidir com a chuva "da cidade" em vez da chuva "do talhão" é onde a perda se instala. E isso não é secundário: boa parte das perdas de produtividade de uma lavoura está ligada a variáveis climáticas **locais** — chuva, molhamento foliar, vento — que só a medição na própria fazenda captura.

É por isso que cada vez mais produtores instalam uma **estação meteorológica na própria sede**. Não para prever o tempo — isso é papel das agências —, mas para **medir o que de fato aconteceu** no seu raio de atuação:

- **Chuva acumulada de verdade (mm)** — o número que define se dá para entrar com a máquina, se o solo está em ponto de plantio e se a lavoura precisa (ou não) de irrigação.
...
Para esse monitoramento local existem estações meteorológicas agrícolas — como a [Beweather](https://beweather.fluxorural.com.br/cotacao), que fica na sede e transmite chuva, ETo, vento e umidade em tempo real —, mas o princípio vale para qualquer equipamento: **decidir com o dado do seu talhão pesa mais do que decidir com a média da região.**
