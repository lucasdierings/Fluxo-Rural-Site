...
const personJsonLd = {
  ...
  knowsAbout: [
    ...
    'Inovação no campo',
    'Marketing e vendas digitais no agronegócio',
...
const localBusinessJsonLd = {
  ...
  name: 'Fluxo Rural Consultoria',
  description: 'Consultoria estratégica em gestão financeira, inovação e marketing digital no agronegócio brasileiro. Consultoria e palestras com Lucas Dierings.',
  url: 'https://fluxorural.com.br',
  telephone: '',
  email: 'lucas@fluxorural.com.br',
  ...
  serviceType: [
    ...
    'Consultoria em Marketing e Vendas Digitais no Agronegócio',
