          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="p-4 bg-white">
                ...
                <h3 className="font-heading text-navy font-bold text-lg mt-2">CNA Jovem — Sistema CNA/SENAR</h3>
                <p className="text-carvao/70 text-sm">Um dos 5 vencedores nacionais entre 3.742 jovens do agronegócio em 2021</p>
              </div>
            </a>
            {/* NHCast */}
            <div className="rounded-xl overflow-hidden group bg-white shadow-lg">
              <div className="relative h-48 overflow-hidden">
                <Image
              ...
              <div className="p-4 bg-white">
                ...
                <h3 className="font-heading text-navy font-bold text-lg mt-2">NHCast — New Holland Brasil</h3>
                <p className="text-carvao/70 text-sm">Podcast oficial da maior fabricante de máquinas agrícolas</p>
              </div>
            </div>
            {/* Agrojovem Podcast */}
            <div className="rounded-xl overflow-hidden group bg-white shadow-lg">
              ...
              <div className="p-4 bg-white">
                ...
                <h3 className="font-heading text-navy font-bold text-lg mt-2">Agrojovem Podcast</h3>
                <p className="text-carvao/70 text-sm mb-3">Compartilhando conhecimento com produtores de todo o Brasil</p>
                <a
